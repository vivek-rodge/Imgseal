...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.lab_logo.place(x= 1100, y= 25)

        # Deails

        school_name = Label(window, text='MESWCOE', fg="black", \
                            bg=None, relief=None, font=("arial", 10, "bold"))
        school_name.place(x=1100, y=180)
        city_name = Label(window, text='Pune', fg ="black", \
                    bg= None, relief= None, font =("arial", 10, "bold"))
        city_name.place(x= 1100, y=200)


        # Group Info
        name = Label(window, text='Branch: BE COMP ', fg ="black", \
                    bg= None, relief= None, font =("arial", 12, "bold"))
        name.place(x= 1100, y=220)
        #id_student = Label(window, text='ID: 16', fg ="black", \
                    #bg= None, relief= None, font =("arial", 12, "bold"))
        #id_student.place(x= 1100, y=210)
        year = Label(window, text='2023-2024', fg ="black", \
                    bg= None, relief= None, font =("arial", 12, "bold"))
        year.place(x= 1100, y=240)
